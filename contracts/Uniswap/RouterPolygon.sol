...
contract RouterUniswapPol is IRouterEvents, IRouterStructs, IRouterErrors{
    // @dev universal router interface
    IUniversalRouter constant ROUTER = IUniversalRouter(0xec7BE89e9d109e7e3Fec59c222CF297125FEFda2);
    // @dev WETH inteface
    IWNATIVE constant internal WETH_WRAPPER = IWNATIVE(0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270);
    ...
    IUniswapV2Factory constant internal V2_FACTORY = IUniswapV2Factory(0x9e5A52f57b3038F1B8EeE45F28b3C1967e22799C);
